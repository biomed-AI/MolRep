...
def mol_collate_func(batch):
    ...
    return [torch.tensor(features) for features in (adjacency_list, features_list, distance_list, labels)]
...
def MAT_construct_dataset(features_path, train_idxs=None, valid_idxs=None, test_idxs=None):
