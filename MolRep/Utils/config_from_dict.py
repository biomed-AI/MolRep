...
from MolRep.Models.sequences_based.MAT import MAT
from MolRep.Models.sequences_based.BiLSTM import BiLSTM
from MolRep.Models.sequences_based.SALSTM import SALSTM
from MolRep.Models.sequences_based.Transformer import Transformer
...
from MolRep.Models.graph_based.DeepMultisets import DeepMultisets
...
from MolRep.Utils.parser import read_config_file
...
class DatasetConfig:
    ...
    Data = {
        ...
        # Physical Chemistry
        'ESOL': {
            'path': 'ESOL/delaney-processed.csv',
            'smiles_column': 'smiles',
        ...
        'Lipophilicity': {
            'path': 'Lipophilicity/Lipophilicity.csv',
            'smiles_column': 'smiles',
            'target_columns': ['exp'],
            'task_type': 'Regression',
            'metric_type': 'rmse',
        ...
        'Toy':{
            'path': 'Toy/toy_label_1_mw350.csv',
            'smiles_column': 'SMILES',
