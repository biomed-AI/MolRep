...
from molrep.processors.features import graph_data_obj_to_nx_simple, nx_to_graph_data_obj_simple
...
class ExtractSubstructureContextPair:
    ...
    def __init__(self, config):
        ...
        k = model_config.get("num_layer", 5)
        l1 = model_config.get("num_layer", 5) - 1
        l2 = l1 + model_config.get("csize", 3)
...
class MaskAtom:
    def __init__(self, config):
        ...
        masked atoms """
        model_config = config.model_cfg
        num_atom_type = model_config.get("num_atom_type", 119)
        num_edge_type = model_config.get("num_edge_type", 5)
        mask_rate = model_config.get("mask_rate", 0.15)
        mask_edge = model_config.get("mask_edge", True)
