...
def parse_args():
    ...
    parser.add_argument("--cfg-path", required=False, default=None, help="path to configuration file.")
    parser.add_argument("--job-id", required=False, default='now', type=str, help=".")
    parser.add_argument(
        "--options",
        nargs="+",
